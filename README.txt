...
- **Live study rooms (video)**
  WebRTC-based focus rooms with optional camera/mic, synchronized Pomodoro timers, and lightweight presence indicators.

- **Richer audio**
  More curated lofi playlists, basic controls, and the ability to add ambient sound sets.
